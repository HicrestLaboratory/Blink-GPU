...
int main(int argc, char* argv[]) {
  ...
  double timeTakenMPI = 0.0, timeTakenCUDAIPC = 0.0, timeTakenCUDACPY = 0.0, timeTakenCOMPUTE = 0.0;
  ...
  SET_EXPERIMENT_NAME(4, "sweep3d")
  SET_EXPERIMENT_TYPE(4, "nvlink")
  SET_EXPERIMENT(4, "Compu")
  ...
  if (nnodes > 1) {
    ...
    SET_EXPERIMENT_LAYOUT(4, "interNodes")
  } else {
    ...
    SET_EXPERIMENT_LAYOUT(4, "intraNode")
  }
  ...
  ADD_TIME_EXPERIMENT(4, timeTakenCOMPUTE)
