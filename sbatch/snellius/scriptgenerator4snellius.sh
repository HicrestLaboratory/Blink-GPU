...
mkdir -p sout
cat "${EXPORT_PATH}"
source ${MODULE_PATH} && source ${EXPORT_PATH} && <sl-export> <sl-exp-and> mpirun -np ${SLURM_NTASKS} bin/<exp-name>_<exp-type> <exp_args>
EOF
)
    ...
    do
        ...
        do
            ...
            then
                ...
                out_script_file="sbatch/snellius/run-snellius-$name-$type-$topo.sh"
