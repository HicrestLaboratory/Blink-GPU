...
void new_read_line_parameters (int argc, char *argv[], int myrank,
                           int *flag_b, int *flag_l, int *flag_x,
                           int *loop_count, int *buff_cycle, int *fix_buff_size, int* max_j ) {
...
void print_line_parameters (int myrank,
                           int flag_b, int flag_l, int flag_x,
                           int loop_count, int buff_cycle, int fix_buff_size, int max_j ) {
